...
using ITokenService = RemoteControlUbuntu.Infrastructure.Abstractions.Services.ITokenService;
    ...
    : ITokenService
{
    ...
    public async Task RevokeTokenAsync(ClaimsPrincipal principal)
    {
        ...
        if (user == null) throw new CredentialValidationException("Invalid client request");
    ...
    public string CreateAccessToken(ClaimsIdentity claims)
    {
        try
        {
            ...
            var privateKey = Encoding.ASCII.GetBytes(_jwtSecret);
